        ...
        <div className="relative z-10 container mx-auto px-4 h-full flex items-center">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <div className="text-white">
              ...
              <Link
                href="/apply"
                className="inline-block bg-yellow-600 hover:bg-blue-700 text-white font-bold py-4 px-8 rounded-lg text-lg transition-colors duration-200 transform hover:scale-105"
              >
                Apply Now
              </Link>
            </div>
            ...
            <div className="space-y-6">
              ...
              <section className="bg-white rounded-lg shadow-md p-6">
                ...
                <p className="text-gray-600 text-sm mb-4">
                  ...
                  1985, we're committed to promoting athletic excellence and
                  island pride.
                </p>
                <Link
                  href="/about"
